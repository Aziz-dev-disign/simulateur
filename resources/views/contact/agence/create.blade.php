...
<form class="form-horizontal form-label-left"  method="POST" action="#" enctype="multipart/form-data">
    ...
    <div class="item form-group row">
        ...
        <div class="col-md-7">
            <input type="email" id="email"  required="required" class="form-control col-md-7 @error('email') is-invalid @enderror " name="email" placeholder="veillez entrer un email"  value="{{ old('email') }}" required autocomplete="email" autofocus>            
            @error('email')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
    ...
    <div class="item form-group row">
        ...
        <div class="col-md-7">
            <input type="text" id="telephone"  required="required" class="form-control col-md-7 @error('telephone') is-invalid @enderror" name="telephone"  value="{{ old('telephone') }}" placeholder="Entrez un téléphone" required autofocus>            
            @error('telephone')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
    ...
    <div class="item form-group row">
        ...
        <div class="col-md-7">
            <input type="text" id="ville" name="ville"  required="required" class="form-control col-md-7 @error('ville') is-invalid @enderror" placeholder="Entrez la ville" required autofocus>            
            @error('ville')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
